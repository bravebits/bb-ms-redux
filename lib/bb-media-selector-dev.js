...
})(this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_9__, __WEBPACK_EXTERNAL_MODULE_23__) {
...
function addUploadingFile(files, file) {
...
function handleUploadFile(path, endPoint, file, fileName, onProcess) {
	return function (dispatch) {
		joomlaApi.handleUploadFile(path, endPoint, file, fileName, onProcess).then(function (res) {
			if (res && res.message === 'done') {
				var uploadedFile = _underscore2.default.find(res.list, function (item) {
...
function handleUploadFiles(currentFiles, uploadFiles) {
	return function (dispatch) {
		_underscore2.default.each(uploadFiles, function (file) {
			return dispatch(addUploadingFile(currentFiles, file));
		});
	};
}
...
function isMedia(name) {
	return name.toLowerCase().match(/.(bmp|gif|ico|jpg|jpeg|png)$/);
}
...
var handleUploadFile = exports.handleUploadFile = function handleUploadFile() {
	...
	var onProcess = arguments[4];
	var allowType = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : [];
...
var uploadFile = exports.uploadFile = function uploadFile(endPoint, data, resolve, reject, onProcess) {
 ...
 * @return {$.ajax} : Use .done(res => {}) to handle this ajax request
 */
var createFolder = exports.createFolder = function createFolder(endPoint) {
...
var _HideSidebarButton = __webpack_require__(76);
...
var _UploadingFile = __webpack_require__(71);

var _UploadingFile2 = _interopRequireDefault(_UploadingFile);

var _Directory = __webpack_require__(72);
...
var _ScreenHeader = __webpack_require__(73);
...
var _BackButton = __webpack_require__(74);

var _BackButton2 = _interopRequireDefault(_BackButton);

var _DropZone = __webpack_require__(75);
	...
	_createClass(File, [{
		...
		value: function render() {
			...
			return libs.isMedia(this.props.data.name) ? _react2.default.createElement('div', {
				...
				src: '' + this.props.baseURL + this.props.currentPath + this.props.data.name
...
var UploadingFile = function (_Component) {
  ...
  _createClass(UploadingFile, [{
    ...
    value: function componentDidMount() {
      ...
      this.props.handleUploadFile(currentPath, config.uploadFile, data.uploading, data.name, function (percentage) {
