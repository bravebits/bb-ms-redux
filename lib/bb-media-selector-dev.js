...
})(this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_23__) {
...
function expandTreeNode(path, endPoint, treeNodes) {
	return function (dispatch) {
	...
	_createClass(App, [{
		...
		value: function fetchFiles() {
			...
			return new Promise(function (resolve) {
				var dirs = _this4.props.localPath.split('/').slice(0, -1);
				var path = '';
				_.each(dirs, function (dir) {
					path += dir + '/';
					_this4.props.getAllFiles(path, _this4.props.config.getAllFiles);
				});
				_this4.props.setCurrentPath(_this4.props.localPath);
			});
		}
	}, {
		key: 'render',
	...
	function TreeNode() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TreeNode.__proto__ || Object.getPrototypeOf(TreeNode)).call.apply(_ref, [this].concat(args))), _this), _this.browseFiles = function () {
			...
			if (!_this.props.isExpanded) {
				_this.props.expandTreeNode(_this.props.path, _this.props.config.getAllFiles, _this.props.treeNodes);
			} else {
