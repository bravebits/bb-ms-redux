...
})(this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_9__, __WEBPACK_EXTERNAL_MODULE_23__) {
...
var _joomla = __webpack_require__(63);
...
var _generalReducer = __webpack_require__(54);

var _generalReducer2 = _interopRequireDefault(_generalReducer);

var _fileReducer = __webpack_require__(55);
...
var config = {
	...
	getFullDirectory: 'http://pb.box/dev/index.php?pb2ajax=1&task=getFullDirectory',
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(12), __webpack_require__(45)(module)))
...
var _MainScreen = __webpack_require__(69);

var _MainScreen2 = _interopRequireDefault(_MainScreen);

var _HideSidebarButton = __webpack_require__(74);
...
var SideBar = function (_Component) {
	...
	_createClass(SideBar, [{
		...
		value: function render() {
			...
			}, _react2.default.createElement('div', { className: '' + _index2.default['tree-view'] }, _react2.default.createElement(_TreeNode2.default, {
				path: '/',
				name: 'images',
				type: 'dir',
				key: 'images'
	...
	_createClass(TreeNode, [{
		...
		value: function render() {
			...
			if (this.state.isExpanded) {
				...
				}, ' ', this.props.name))), _react2.default.createElement('div', { className: '' + _index2.default['tree-view__sub-item'] }, _underscore2.default.map(this.state.children, function (child) {
...
var _Directory = __webpack_require__(71);
...
var _ScreenHeader = __webpack_require__(72);
...
var _BackButton = __webpack_require__(73);
...
var File = function (_Component) {
	...
	_createClass(File, [{
		...
		value: function render() {
			...
			return libs.isImage(this.props.data.name) ? _react2.default.createElement('div', {
			...
			}, this.props.data.name)), _react2.default.createElement('div', { className: '' + _index2.default['list-media__item__dimensions'] }, libs.isImage(this.props.data.name) ? _react2.default.createElement('span', null, this.props.data.image_width + 'x' + this.props.data.image_height) : null), _react2.default.createElement('div', { className: '' + _index2.default['list-media__item__file-size'] }, _react2.default.createElement('span', null, this.props.data.file_size)), _react2.default.createElement('div', { className: '' + _index2.default['list-media__item__remove'] }, _react2.default.createElement('a', { href: '#', onClick: this.deleteFile }, _react2.default.createElement('i', { className: 'fa fa-trash-o' }))))) : this.props.fileType === generalConstants.TYPE_FILE ? _react2.default.createElement('div', {
				onDoubleClick: this.chooseFile,
				onClick: this.selectFile,
				className: _index2.default['list-media__item'] + '  ' + (this.props.isBack ? _index2.default['back'] : '')
			}, _react2.default.createElement('div', {
				...
				onDoubleClick: this.enableEditting,
				onKeyDown: this.handleOnKeyDown
			}, this.props.data.name)), _react2.default.createElement('div', {
				className: '' + _index2.default['list-media__item__dimensions']
			}, libs.isImage(this.props.data.name) ? _react2.default.createElement('span', null, this.props.data.image_width + 'x' + this.props.data.image_height) : null), _react2.default.createElement('div', {
				className: '' + _index2.default['list-media__item__file-size']
			}, _react2.default.createElement('span', null, this.props.data.file_size)), _react2.default.createElement('div', { className: '' + _index2.default['list-media__item__remove'] }, _react2.default.createElement('a', { href: '#', onClick: this.deleteFile }, _react2.default.createElement('i', { className: 'fa fa-trash-o' }))))) : null;
		}
	}]);
	...
	_createClass(Directory, [{
		...
		value: function render() {
			...
			return _react2.default.createElement('div', {
				...
				value: 'option',
				checked: isMultiSelected ? true : false
			}), _react2.default.createElement('label', { htmlFor: 'option' }, _react2.default.createElement('span', null, _react2.default.createElement('span', null))))), _react2.default.createElement('div', { className: _index2.default['list-media__item__avatar'] + ' ' + _index2.default['list-media__item__folder'] }, _react2.default.createElement('a', { onClick: this.openFolder }, _react2.default.createElement('i', { className: 'fa fa-folder-o' }))), _react2.default.createElement('div', { className: '' + _index2.default['list-media__item__title'] }, _react2.default.createElement('span', {
				ref: function ref(r) {
					return _this2.name = r;
				},
				onDoubleClick: this.enableEditting,
...
var BackButton = function (_Component) {
	...
	_createClass(BackButton, [{
		...
		value: function render() {
			...
			return currentPath !== '/' ? _react2.default.createElement('div', {
				onClick: this.goBack,
